...
namespace WebWallpaper.Wallpaper
{
    public class BrowserManager : IDisposable
    {
        ...
        public void InitBrowser(ConfigEntry configEntry)
        {
            if (Ready)
                return;
            ...
            Browser = ChromiumFactory.Instance.CreateBrowser(new BrowserSettings() { SkipCorsCheck = true }, configEntry.startURL);
